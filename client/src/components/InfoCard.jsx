const InfoCard = ({ title, content, logo, socialMedia }) => {
  return (
    <div
      className={`relative text-center text-white border border-white w-[374px] h-[134px] rounded-[15px] bg-transparent overflow-visible mx-auto`}
    >
      {logo && (
